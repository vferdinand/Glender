...
public:
    Triangle(const std::vector<uint32_t>& vertexIndices, const std::array<uint32_t, 3>& normalIndices, u_int16_t materialIndex = 0,  const std::vector<uint32_t>& textureIndices = {0});
